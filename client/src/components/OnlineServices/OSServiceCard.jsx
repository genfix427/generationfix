            ...
            onlineServices.map((service, index) => (
              <div className='py-[30px] px-3 lg:px-5 shadow-lg hover:shadow-2xl hover:border hover:rounded-b-[40px] transition-all' key={index}>
                ...
                <div className="flex items-center justify-between mt-[30px]">
                  <Link to={`/services/${service.slug}`} className='py-2 px-4 rounded-md border border-solid border-green300 mt-[30px] flex items-center justify-center group hover:bg-textColor hover:border-black shadow-md transition-all'>
